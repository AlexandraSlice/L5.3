...
read_more_1120.addEventListener("click", function () {
  ...
  for (let hidden_logo_1120 of logos_1120) { 
      ...
      if (hidden_logo_1120.style.display === "none") { hidden_logo_1120.style.display = "flex"; next_text_read_768.innerHTML = a; next_mnemonic_symbol_768.style.transform = 'rotate(270deg)'}
